...
function (angular, app, _, $, d3) {
  ...
  var module = angular.module('kibana.panels.facetView', []);
  app.useModule(module);

  module.controller('facetView', function($scope, dashboard, querySrv, filterSrv) {
    $scope.panelMeta = {
      modals: [
        {
          description: 'Inspect',
      ...
      status: 'Experimental',
      description: 'facet-view for Experimental uses'
    };
